import { clearTime, clocktimer, getSec, min, resetTime, sec, time, timer } from "../utils/clocktimer.js";
import { openResultWindow, checkGameState, gameState_modals, changeGameState_modals, gamePause } from "./modals.js";
