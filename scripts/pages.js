        ...
        `<section id="game" class="game">
            ...
            <div class="game-field">
                <div class="game-field__container" id="gameContainer_1">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail1" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes1" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_1" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_2">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail2" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes2" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_2" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_3">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail3" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes3" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_3" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_4">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail4" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes4" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_4" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_5">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail5" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes5" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_5" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_6">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail6" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes6" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_6" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_7">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail7" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes7" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_7" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_8">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail8" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes8" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_8" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_9">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail9" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes9" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_9" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_10">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail10" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes10" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_10" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_11">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail11" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes11" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_11" src="/match-match/assets/images/card-top.png" />
                </div>
                <div class="game-field__container" id="gameContainer_12">
                    ...
                    <img src="/match-match/assets/icons/cross.png" alt="" id="fail12" class="failHide gameImageStateIcon" />
                    <img src="/match-match/assets/icons/check.png" alt="" id="succes12" class="succesHide gameImageStateIcon" />
                    <img class="cardCover" id="backsideCard_12" src="/match-match/assets/images/card-top.png" />
                </div>
            </div>
        </section>`,
    about:
